...
import { Grid, Container , Box, Typography, Button, IconButton,
} from "@mui/material";
...
export default function Home() {
  return (
    ...
    <Container>
    <Typography variant="h6" sx={{ fontWeight: "600", fontSize: "16px", mt: 5, }}>
        Showing  20 result of “Development”
            </Typography>
            <Box sx={{ display: "flex", justifyContent: "space-between", alignItems: "center" }}>
            <Typography variant="h6" sx={{ fontWeight: "500", fontSize: "16px", mt: 5, mb: 5 }}>
      ...
      <Box sx={{ display: "flex", alignItems: "center", gap: 1 }}>
        ...
        <Typography variant="body2" color="#000000" sx={{ fontWeight: "bold" }}>
        Newest
        </Typography>
        </Box>
            </Box>
...
const jobs = [
  {
    ...
    description: "One of the biggest technology company in the world. We focus on making a big impact.",
    salary: "$80K",
  ...
  },
  {
    ...
    company: "Google Inc.",
    description: "Biggest Technology company in the world needed your skill set to contribute to our company.",
    salary: "$200K",
    employmentType: "Fulltime",
    level: "Senior Level",
    isSelected: true,
  },
  {
    ...
    company: "Apple Inc.",
    description: "We provide you to expand your skill here. Improve yourself with us and be the best version you",
    salary: "$96K",
    employmentType: "Fulltime",
    level: "Junior Level",
    isSelected: false,
